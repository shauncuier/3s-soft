    ...
    <div className="bg-gray-900 min-h-screen pt-24 sm:pt-28 md:pt-38 pb-20 px-4">
      <div className="max-w-4xl mx-auto">
        <PageTitle
          ...
          content="Learn how 3s-Soft uses cookies to enhance user experience for our global clients, compliant with GDPR and US regulations."
        />
        ...
        <div className="space-y-10 text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/5 p-5 rounded-xl border border-white/10">
                ...
                <p>These cookies allow us to remember the choices you make (such as your username or language) to personal-ize your experience.</p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-8 space-y-2">
              <li><a href="https://support.google.com/chrome/answer/95647" target="_blank" className="text-blue-400 hover:underline">Google Chrome settings</a></li>
              <li><a href="https://support.mozilla.org/en-US/kb/cookies-information-websites-store-on-your-computer" target="_blank" className="text-blue-400 hover:underline">Mozilla Firefox settings</a></li>
              <li><a href="https://support.apple.com/guide/safari/manage-cookies-and-website-data-sfri11471/mac" target="_blank" className="text-blue-400 hover:underline">Safari settings</a></li>
            </ul>
          </section>
